...
#  Apr 14, 2022 09:52:14 AM PDT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top2 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 943x450+1885+815
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ttk::entry $site_3_0.tEn49 \
        ...
        -cursor xterm 
    vTcl:DefineAlias "$site_3_0.tEn49" "TEntry1" vTcl:WidgetProc "vehicle_search" 1
    ttk::entry $site_3_0.tEn50 \
        -font TkTextFont -foreground {} -background {} -takefocus {} \
        -cursor xterm 
    vTcl:DefineAlias "$site_3_0.tEn50" "TEntry1" vTcl:WidgetProc "vehicle_search" 1
    ttk::entry $site_3_0.tEn51 \
        -font TkTextFont -foreground {} -background {} -takefocus {} \
        -cursor xterm 
    vTcl:DefineAlias "$site_3_0.tEn51" "TEntry1" vTcl:WidgetProc "vehicle_search" 1
