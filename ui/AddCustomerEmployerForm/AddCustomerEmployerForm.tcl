...
#  Apr 25, 2022 08:32:48 AM PDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 600x450+894+427
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab46 \
        ...
        -foreground $vTcl(actual_gui_fg) -text {Add Employer Information} 
    vTcl:DefineAlias "$top.lab46" "Label1" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab47 \
        -anchor w -background $vTcl(actual_gui_bg) -compound left \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -text Company 
