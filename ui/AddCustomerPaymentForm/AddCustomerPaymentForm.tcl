...
#  May 01, 2022 03:57:53 PM PDT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 792x757+983+931
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $top.but49 \
        ...
        -background $vTcl(actual_gui_bg) -borderwidth 1 -command Submit \
    ...
    vTcl::widgets::ttk::custom::CreateCmd $top.cus69 \
        -background $vTcl(actual_gui_bg) -height 229 -highlightcolor black \
        -width 694 
    ...
    place $top.lab47 \
        -in $top -x 20 -y 60 -width 105 -relwidth 0 -height 29 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.ent48 \
        -in $top -x 477 -y 54 -width 144 -relwidth 0 -height 20 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but49 \
        -in $top -x 654 -y 54 -width 107 -relwidth 0 -height 24 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab51 \
    ...
    place $top.cus69 \
        ...
        -anchor nw -bordermode ignore 
    place $top.tCo79 \
        -in $top -x 144 -y 54 -width 285 -relwidth 0 -height 36 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.cus80 \
