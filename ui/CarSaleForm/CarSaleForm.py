...
#    Apr 27, 2022 12:49:17 PM PDT  platform: Linux
...
class VehicleSaleForm:
    def __init__(self, top=None):
        ...
        self.WorkHistory = tk.Text(self.top)
        self.WorkHistory.place(relx=0.378, rely=0.501, relheight=0.137
                , relwidth=0.607)
        self.WorkHistory.configure(background="white")
        self.WorkHistory.configure(font="TkTextFont")
        self.WorkHistory.configure(selectbackground="blue")
        self.WorkHistory.configure(selectforeground="white")
        self.WorkHistory.configure(wrap="word")
