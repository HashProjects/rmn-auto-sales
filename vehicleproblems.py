class VehicleProblem:
    ...
    def __init__(self,
                 purchase_id, vehicle_id, problem_id, problem_description, estimated_repair_cost,
                 actual_repair_cost):
    ...
    def __str__(self):
        return "VehicleProblem({}: {}".format(self.problem_description, self.estimated_repair_cost)
